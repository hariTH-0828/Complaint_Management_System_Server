...
public class WaterController {
	...
	public ResponseEntity<Water> getComplaintBycId(@PathVariable("complaintId") String id) {
		return new ResponseEntity<Water>(waterRepository.findByComplaintId(id), HttpStatus.OK);
	}
}
